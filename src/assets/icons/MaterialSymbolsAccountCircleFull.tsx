...
type MaterialSymbolsAccountCircleFullProps = SVGProps<SVGSVGElement> & {
  color: string;
  width?: string;
  height?: string;
};

export function MaterialSymbolsAccountCircleFull(
  props: MaterialSymbolsAccountCircleFullProps
) {
  return (
    <svg
